...
import { createActionCreator, createReducer } from '@src/common/utils/reduxHelpers';
...
export const selectApiCallById = (state, apiCallId) => selectApiCalls(state)[apiCallId] || 0;
